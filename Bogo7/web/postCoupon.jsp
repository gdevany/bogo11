    ...
    <body>
        ...
        <form method="POST" action="main">
            ...
            <table id="formtable">
                ...
                type="text" value="${coupon.bizName}" name="bizName" class="textbox" placeholder="Max 40 characters."/></td></tr>
                <tr><td>BUY ONE:</td><td><input  
                type="text" value="${coupon.bogoDesc}" name="bogoDesc" class="textbox" placeholder="Max 40 characters.">&nbsp;(get one free)</td></tr>
                <tr><td>Address of participating location:</td><td><input
                type="text" value="${coupon.bizLoc}" name="bizLoc" class="textbox" placeholder="Max 60 characters"/></td></tr>
                <tr><td>Max value: $</td><td><input  
                type="text" value="${coupon.couponValue}" name="couponValue" class="textbox2" placeholder="max $ amt"/></td></tr>
                <tr><td>ZipCode1:</td><td><input  
                type="text" value="${coupon.zip1}" name="zip1" class="textbox2" placeholder="Zipcode"/></td></tr>
                <tr><td>ZipCode2:</td><td><input  
                type="text" name="zip2" class="textbox2" placeholder="optional"/></td></tr>
                <tr><td>ZipCode3:</td><td><input  
                type="text" name="zip3" class="textbox2" placeholder="optional"/></td></tr>
